...
ax.spines['bottom'].set_position(('data', -0.0125))  # 让X轴位于Y轴的0.3位置
...
# 设置标题和Y轴标签
# ax.set_title('次要任务错误率 (轻负荷)', fontsize=16, fontweight='bold')
ax.set_ylabel('错误率', fontsize=16, fontweight='bold')
ax.text(0.4, -0.2, '(c) 错误率 (轻负荷)', transform=ax.transAxes, ha='center', va='top', fontsize=17, fontweight='normal')

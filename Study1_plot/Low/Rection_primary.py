...
# 设置标题和Y轴标签
ax.set_title('RT(Primary Task,Light)', fontsize=12)
...
# 保存为矢量图
plt.savefig("E:/Desktop/Study1_Data/Low Task/" + file_name + ".jpg", format="jpg", bbox_inches='tight', dpi=300)  # 保存为 SVG 矢量图格式

...
Intrusiveness_column = '侵入性'  # 替换为实际的列名
...
noticeability_column = '易察觉性'  # 替换为实际的列名
...
Understandability_column = '易懂性'  # 替换为实际的列名
...
ax.text(0.45, -0.15, '(b) 问卷评分', transform=ax.transAxes, ha='center', va='top', fontsize=20, fontweight='normal')

# 设置图例在底部并横向排列
ax.legend(loc='upper center', bbox_to_anchor=(0.5, 1.08), ncol=3, fontsize=17, frameon=False)

# 保存为 SVG 文件
plt.savefig("E:/Desktop/paper/Study2_Data/Questionnaire_zh.jpg", format="jpg", bbox_inches='tight', dpi=300)  # 保存为 JPG 格式

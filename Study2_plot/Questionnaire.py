...
# 替换为你的文件路径
file_path = "E:/Desktop/Study2_Data/Questionnaire.xlsx"  # 替换为实际的文件路径
...
# 保存为 SVG 文件
plt.savefig("E:/Desktop/Study2_Data/Questionnaire.jpg", format="jpg", bbox_inches='tight', dpi=300)  # 保存为 SVG 格式

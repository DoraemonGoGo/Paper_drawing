...
ax.tick_params(axis='y', labelsize=16)  # 设置 y 轴刻度标签字体大小为 20
...
# ax.text(0.4, -0.15, '(b)', transform=ax.transAxes, ha='center', va='top', fontsize=18, fontweight='normal', fontname='Times New Roman')
ax.text(0.45, -0.2, '(b) 错误率', transform=ax.transAxes, ha='center', va='top', fontsize=17, fontweight='normal')
# plt.legend(title='负荷')
...
# 保存为矢量图
plt.savefig("E:/Desktop/paper/Study2_Data/error_zh.jpg", format="jpg", bbox_inches='tight', dpi=300)  # 保存为 JPG 格式

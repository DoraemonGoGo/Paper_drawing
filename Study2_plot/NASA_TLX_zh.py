...
ax.set_xticklabels(['脑力需求', '体力需求', '时间需求', '绩效', '努力程度', '受挫感'], fontsize=15)
# ax.set_xticklabels(metrics, fontsize=13)

# 调整Y轴刻度字体大小
ax.tick_params(axis='y', labelsize=22)  # 设置Y轴刻度字体大小为 22
...
# 显示图例
ax.legend(loc='upper left', fontsize=22, frameon=False, ncol=3)

# 调整图表布局并显示
plt.tight_layout()

# 保存为矢量图
plt.savefig("E:/Desktop/paper/Study2_Data/nasa_tlx_with_total_zh.pdf", format="pdf", dpi=300)  # 保存为 SVG 矢量图格式

...
# 读取CSV文件
file_path = 'E:/Desktop/Study2_Data/rection.xlsx'  # 请替换为实际文件名
...
# 保存为矢量图
plt.savefig("E:/Desktop/Study2_Data/rection.jpg", format="jpg", bbox_inches='tight', dpi=300)  # 保存为 SVG 矢量图格式
